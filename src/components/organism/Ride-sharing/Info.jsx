...
const Info = () => {
    return (
        <div className='flex flex-col-reverse md:flex-row justify-center items-center bg-colorBlue p-6 md:p-10'>
            ...
            <div className='w-full md:w-1/2 md:mt-0 flex justify-start'>
