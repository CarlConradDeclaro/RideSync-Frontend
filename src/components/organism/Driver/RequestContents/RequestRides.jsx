...
const RequestRides = () => {
    const { driverMap, request, openInfoModal, selectedPosition, selectedPositionDest, requestInfo, customIcon, handleOfferRide } = useContext(RequestContext);
            ...
            <div className='md:flex gap-5 md:justify-center grid grid-col-1'>
                ...
                </div>
                {
                    selectedPosition && openInfoModal && (
                        <div className='w-full md:max-w-[400px] h-[590px] animate-slideDown'>
